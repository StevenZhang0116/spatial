...
if __name__ == "__main__":
    ...
    for i in range(nn):
        ...
        for j in range(nn):
            ...
            if cell_id1 != cell_id2: 
                cnt += 1
                [soma1_loc, neuron1_type, pre1_loc, _, _] = extract_neuron_synaptic_info(cell_id1, 'pre', cell_table, synapse_table)
                [soma2_loc, neuron2_type, pre2_loc, _, _] = extract_neuron_synaptic_info(cell_id2, 'pre', cell_table, synapse_table)
    ...
    np.save('conn.npy', conn)
    np.save('ttpp.npy', ttpp)
